...
function handleGrasp() {
    ...
    dynamicObject = createMoveNumber(gameScreenObject, [endEffectObject.x + endEffectObject.width / 2, endEffectObject.y + endEffectObject.height / 2], gameScreenObject.gameData.number)
    endEffectObject.visible = false
    // 加分
